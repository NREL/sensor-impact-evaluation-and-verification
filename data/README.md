# sensor_impact_FDD: Raw Data Preparation

If the user chooses "General Guidance" mode, the analysis is based on the fault building simulation data that calibrated on Oak Ridge National Laboratory's Flexible Research Platform.
...
Unzip the downloaded data and copy-paste them under this folder.
